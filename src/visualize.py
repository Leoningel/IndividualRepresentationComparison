...
if __name__ == "__main__":
    ...
    folder_names = [f'results/{folder}/dsge', f'results/{folder}/treebased', f'results/{folder}/ge']
    labels = [ 'dSGE', 'Tree-based', 'GE' ]
    folders = [ 'dsge', 'treebased', 'ge' ]

    plot_fitness_comparison(folder_names=folder_names, labels=labels, labels_name='Representation',file_name=f'results/{folder}/fitness_comp_.pdf', title=f'Fitness comparison ({folder})')
    plot_nodes_comparison(folder_names=folder_names, labels=labels, labels_name='Representation',file_name=f'results/{folder}/nodes_comp_.pdf', title=f'Nodes comparison ({folder})')
    plot_nodes_comparison(y_axis='Depth', folder_names=folder_names, labels=labels, labels_name='Representation',file_name=f'results/{folder}/depth_comp_.pdf', title=f'Depth comparison ({folder})')
    plot_test_fitness_comparison(folder_names=folder_names, labels=labels, labels_name='Representation',file_name=f'results/{folder}/test_fitness_comp_.pdf', title=f'Test fitness comparison ({folder})')
