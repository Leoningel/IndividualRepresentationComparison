...
if __name__ == "__main__":
    ...
    if example == 'cnn':
        from examples.CNN import fitness_function, grammar, data_train, data_test, params
        ff_train = fitness_function(data_train)
        ff_test = fitness_function(data_test)
    elif example == 'hpo':
        from examples.HPO import fitness_function, grammar, data_train, data_test, params
        ff_train = fitness_function(data_train)
        ff_test = fitness_function(data_test)
        ...
        from examples.game_of_life import fitness_function, grammar, fitness_function_test, params
        ff_train = fitness_function
